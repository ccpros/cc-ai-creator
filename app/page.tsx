...
const features = [
  ...
  },
  {
    ...
    description: "Generate amazing eye-catching thumbnails using AI. Boost your click-through rates with compelling visuals,",
    icon: ImageIcon,
  ...
  {
    title: "Shot Script",
    description: "Get detailed step-by-step instructions to recreate viral videos. Lern shooting technique, angles, and editing tips from successful content.",
    icon: Video,
    iconBg: "bg-red-100",
...
export default function Home() {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center gap-10 text-center mb-12">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">Meet Your Personal{" "}
            <span className="bg-gradient-to-r from-green-600 to-green-400 bg-clip-text text-transparent">Custom Content Pros AI</span>
          </h1>
    ...
    <section className="py-20 bg-white">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {features.map((feature, index) => {
          ...
          return (
            <div key={index} className="bg-white p-6 rounded-xl border border-gray-200 hover:border-blue-500 transition-a duration-300">
    ...
    {/* Footer Section */}
    <section className="py-20 px-4 md:px-0 bg-gradient-to-r from-green-600 to-green-400">
